...
const defaultImage = `https://dev-mygrandmarecipes.pantheonsite.io/wp-content/uploads/2024/10/loading.webp`;
...
const TableOfContents = ({ toc }: { toc: { text: string; id: string }[] }) => (
  <nav className="lg:w-2/12 hidden lg:block">
    <div className="sticky top-[100px]">
      <h2
        className={`${archivo.className} font-semibold text-xl mb-5 underline text-slate-700 decoration-lime-500 underline-offset-[3px]`}
      >
        In This Section
      </h2>
  ...
  <article className="lg:w-7/12 border-0 lg:border-x-2 border-slate-100 px-0 lg:px-8">
    <header>
      ...
      <div className="flex justify-start items-center gap-3 mb-8">
        <div
          className="h-11 w-11 bg-slate-200 mask mask-hexagon bg-cover bg-center"
