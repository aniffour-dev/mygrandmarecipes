            ...
            posts.map((post) => (
              <article key={post.id} className="overflow-hidden">
                ...
                <div className="my-3">
                  ...
                  <Link href={post.slug}>
                    <h3
                      className="text-xl font-semibold mb-2 text-gray-900 hover:text-lime-600 transition-colors duration-300"
      ...
      {hasNextPage && !initialLoading && (
        <div className="flex justify-center mt-8">
          <button
            ...
            disabled={isLoading}
            className="bg-lime-500 hover:bg-lime-400 text-gray-900 px-6 rounded py-2 font-semibold transition-colors duration-200 disabled:bg-lime-200"
          >
